          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                />
                <img
                  src="/demis mascotte1.png"
                  alt="Mascotte"
                  className="w-16 h-16 object-contain"
                />
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-800 leading-tight">
                {settings.home_hero_title || 'Bienvenue aux Copains d\'abord'}
              </h1>
              <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                {settings.home_hero_subtitle ||
                  'L\'accueil de loisirs qui fait grandir vos enfants dans la joie et la bonne humeur !'}
              </p>
            ...
            <div className="relative">
              ...
              <img
                src="/WhatsApp Image 2025-05-10 à 15.47.25_a8b50be4.jpg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#84c19e] to-[#328fce] rounded-2xl p-8 text-white shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4">
                <img src="/crayon.png" alt="" className="w-10 h-10 object-contain" />
              </div>
            ...
            <div className="bg-gradient-to-br from-[#ffbf40] to-[#ff9fa8] rounded-2xl p-8 text-white shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4">
                <img src="/duo épaule.png" alt="" className="w-10 h-10 object-contain" />
              </div>
            ...
            <div className="bg-gradient-to-br from-[#ff6243] to-[#ff9fa8] rounded-2xl p-8 text-white shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-4">
                <img src="/demis mascotte1.png" alt="" className="w-10 h-10 object-contain" />
              </div>

      ...
      <div className="container mx-auto px-4">
        ...
        <div className="md:hidden -mx-4">
          <Swiper
            ...
            pagination={{
              clickable: true,
              bulletActiveClass: 'swiper-pagination-bullet-active !bg-[#328fce]',
            }}
        ...
        {/* Desktop: Grid layout */}
        <div className={`hidden md:grid grid-cols-1 ${highlights.length === 1 ? 'md:grid-cols-1 max-w-2xl mx-auto' : highlights.length === 2 ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-8`}>
          {highlights.map((highlight) => renderHighlightContent(highlight))}
        </div>
      </div>
    </section>
  );
